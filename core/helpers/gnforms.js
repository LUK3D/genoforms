...
exports.logFile = exports.makeForm = void 0;
var fs = require('fs');
function geerateFilename() {
...
function makeForm(schema) {
    return __awaiter(this, void 0, Promise, function () {
        ...
        return __generator(this, function (_a) {
            html = [];
            result = fs.readFileSync(__dirname + ("/templates/m/" + schema.lang + ".txt"), 'utf-8');
